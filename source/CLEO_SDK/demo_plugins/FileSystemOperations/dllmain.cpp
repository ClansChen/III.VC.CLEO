...
eOpcodeResult WINAPI Script_FS_DeleteFile(CCustomScript* script)
/****************************************************************
Opcode Format
...
****************************************************************/
{
    ...
    CLEO_Script_UpdateCompareFlag(script, DeleteFile(Params[0].cVar));
    return OR_CONTINUE;
}
...
eOpcodeResult WINAPI Script_FS_DeleteDirectory(CCustomScript* script)
/****************************************************************
Opcode Format
...
****************************************************************/
{
    ...
    CLEO_Script_UpdateCompareFlag(script, result);

    return OR_CONTINUE;
}

eOpcodeResult WINAPI Script_FS_MoveFile(CCustomScript* script)
/****************************************************************
Opcode Format
...
eOpcodeResult WINAPI Script_FS_MoveDir(CCustomScript* script)
/****************************************************************
Opcode Format
...
eOpcodeResult WINAPI Script_FS_CopyFile(CCustomScript* script)
/****************************************************************
Opcode Format
...
eOpcodeResult WINAPI Script_FS_CopyDir(CCustomScript* script)
/****************************************************************
Opcode Format
...
{
    CLEO_Script_Collect(script, 2);
    CLEO_Script_UpdateCompareFlag(script, CopyDir(Params[0].cVar, Params[1].cVar));
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD reason, LPVOID lpReserved)
{
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        CLEO_Opcode_RegisterOpcode(OPCODE_FS_DELETEFILE, Script_FS_DeleteFile);
        CLEO_Opcode_RegisterOpcode(OPCODE_FS_DELETEDIR, Script_FS_DeleteDirectory);
        CLEO_Opcode_RegisterOpcode(OPCODE_FS_MOVEFILE, Script_FS_MoveFile);
        CLEO_Opcode_RegisterOpcode(OPCODE_FS_MOVEDIR, Script_FS_MoveDir);
        CLEO_Opcode_RegisterOpcode(OPCODE_FS_COPYFILE, Script_FS_CopyFile);
        CLEO_Opcode_RegisterOpcode(OPCODE_FS_COPYDIR, Script_FS_CopyDir);
    }
    return TRUE;
}