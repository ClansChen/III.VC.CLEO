...
int format(CCustomScript *script, char *str, size_t len, const char *format);
...
eOpcodeResult CustomOpcodes::DUMMY(CCustomScript *script)
{
    return OR_CONTINUE;
}

eOpcodeResult CustomOpcodes::GOTO(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GOTO_IF_TRUE(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GOTO_IF_FALSE(CCustomScript *script)
{
    script->Collect(1);
    if (!script->m_bCondResult)
        script->JumpTo(game.Scripts.Params[0].nVar);
...
eOpcodeResult CustomOpcodes::GOSUB(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::START_CUSTOM_THREAD(CCustomScript *script)
{
    char name[8];
    script->ReadShortString(name);
...
eOpcodeResult CustomOpcodes::MEMORY_WRITE(CCustomScript *script)
{
    script->Collect(4);
    DWORD flOldProtect;
...
eOpcodeResult CustomOpcodes::MEMORY_READ(CCustomScript *script)
{
    script->Collect(3);
    DWORD flOldProtect;
...
eOpcodeResult CustomOpcodes::CALL(CCustomScript *script)
{
    script->Collect(3);
...
eOpcodeResult CustomOpcodes::CALL_FUNCTION(CCustomScript *script)
{
    script->Collect(3);
    void *func = game.Scripts.Params[0].pVar;
    int func_result;
...
eOpcodeResult CustomOpcodes::CALL_METHOD(CCustomScript *script)
{
    script->Collect(4);
    void *func = game.Scripts.Params[0].pVar;
...
eOpcodeResult CustomOpcodes::CALL_FUNCTION_METHOD(CCustomScript *script)
{
    script->Collect(4);
    void *func = game.Scripts.Params[0].pVar;
    void *object = game.Scripts.Params[1].pVar;
...
eOpcodeResult CustomOpcodes::GET_GAME_VERSION(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::GET_CHAR_STRUCT(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_CAR_STRUCT(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_OBJECT_STRUCT(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_CHAR_HANDLE(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_CAR_HANDLE(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_OBJECT_HANDLE(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_THREAD_POINTER(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::GET_NAMED_THREAD_POINTER(CCustomScript *script)
{
    char name[8];
    script->ReadShortString(name);
...
eOpcodeResult CustomOpcodes::IS_KEY_PRESSED(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::FIND_RANDOM_CHAR(CCustomScript *script)
{
    script->Collect(6);
...
eOpcodeResult CustomOpcodes::FIND_RANDOM_CAR(CCustomScript *script)
{
    script->Collect(6);
    unsigned int objcount;
    if (game.Scripts.Params[4].nVar)
...
eOpcodeResult CustomOpcodes::FIND_RANDOM_OBJECT(CCustomScript *script)
{
    script->Collect(5);
    unsigned int objcount;
    if (game.Scripts.Params[4].nVar)
...
eOpcodeResult CustomOpcodes::CALL_POP_FLOAT(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::MATH_EXP(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::MATH_LOG(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::SCM_FUNCTION_RET(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_LABEL_OFFSET(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_VAR_OFFSET(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::BIT_AND(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::BIT_OR(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar | game.Scripts.Params[1].nVar;
    script->Store(1);
...
eOpcodeResult CustomOpcodes::BIT_XOR(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar ^ game.Scripts.Params[1].nVar;
    script->Store(1);
...
eOpcodeResult CustomOpcodes::BIT_NOT(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::BIT_MOD(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar % game.Scripts.Params[1].nVar;
    script->Store(1);
...
eOpcodeResult CustomOpcodes::BIT_SHR(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar >> game.Scripts.Params[1].nVar;
    script->Store(1);
...
eOpcodeResult CustomOpcodes::BIT_SHL(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar << game.Scripts.Params[1].nVar;
    script->Store(1);
...
eOpcodeResult CustomOpcodes::STORE_COORDS_FROM_OBJECT_WITH_OFFSET(CCustomScript *script)
{
    script->Collect(4);
...
eOpcodeResult CustomOpcodes::STORE_COORDS_FROM_CAR_WITH_OFFSET(CCustomScript *script)
{
    script->Collect(4);
...
eOpcodeResult CustomOpcodes::STORE_COORDS_FROM_ACTOR_WITH_OFFSET(CCustomScript *script)
{
    script->Collect(4);
...
eOpcodeResult CustomOpcodes::STORE_PLAYER_CURRENTLY_ARMED_WEAPON(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_CHAR_ARMOUR(CCustomScript *script)
{
    script->Collect(1);
    void* actor = game.Pools.pfPedPoolGetStruct(*game.Pools.pPedPool, game.Scripts.Params[0].nVar);
...
eOpcodeResult CustomOpcodes::PLAYER_DRIVING_PLANE(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::PLAYER_DRIVING_BOAT(CCustomScript *script)
{
    script->Collect(1);
    DWORD player = game.Pools.pCPlayerPedPool[79 * game.Scripts.Params[0].nVar];
    if (*(BYTE *)(player + 0x314))
...
eOpcodeResult CustomOpcodes::PLAYER_DRIVING_HELI(CCustomScript *script)
{
    script->Collect(1);
    DWORD player = game.Pools.pCPlayerPedPool[79 * game.Scripts.Params[0].nVar];
    if (*(BYTE *)(player + 0x314))
...
eOpcodeResult CustomOpcodes::PLAYER_DRIVING_A_MOTORBIKE(CCustomScript *script)
{
    script->Collect(1);
    script->UpdateCompareFlag(false);
    return OR_CONTINUE;
...
eOpcodeResult CustomOpcodes::IS_PC_VERSION(CCustomScript *script)
{
    script->UpdateCompareFlag(true);
    return OR_CONTINUE;
}

eOpcodeResult CustomOpcodes::IS_AUSTRALIAN_GAME(CCustomScript *script)
{
    script->UpdateCompareFlag(false);
    return OR_CONTINUE;
}

eOpcodeResult CustomOpcodes::START_CUSTOM_THREAD_VSTRING(CCustomScript *script)
{
    script->Collect(1);
    char filepath[MAX_PATH];
...
eOpcodeResult CustomOpcodes::IS_BUTTON_PRESSED_ON_PAD(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::EMULATE_BUTTON_PRESS_ON_PAD(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::IS_CAMERA_IN_WIDESCREEN_MODE(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::GET_MODEL_ID_FROM_WEAPON_ID(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::GET_WEAPON_ID_FROM_MODEL_ID(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::SET_MEM_OFFSET(CCustomScript *script)
{
    script->Collect(3);
    DWORD flOldProtect;
    if (game.Scripts.Params[2].nVar)
...
eOpcodeResult CustomOpcodes::GET_CURRENT_WEATHER(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::SHOW_TEXT_POSITION(CCustomScript *script)
{
    script->Collect(3);
...
eOpcodeResult CustomOpcodes::SHOW_FORMATTED_TEXT_POSITION(CCustomScript *script)
{
    script->Collect(3);
    game.Text.textDrawers[*game.Text.currentTextDrawer].x = game.Scripts.Params[0].fVar;
    game.Text.textDrawers[*game.Text.currentTextDrawer].y = game.Scripts.Params[1].fVar;
...
eOpcodeResult WINAPI CustomOpcodes::PLAY_ANIMATION(CCustomScript* script)
{
    script->Collect(4);
    void* actor = game.Pools.pfPedPoolGetStruct(*game.Pools.pPedPool, game.Scripts.Params[0].nVar);
...
eOpcodeResult CustomOpcodes::DRAW_SHADOW(CCustomScript *script)
{
    script->Collect(10);
    int Type = 2;
    CVector pos;
...
eOpcodeResult CustomOpcodes::SET_TEXT_DRAW_FONT(CCustomScript *script)
{
    script->Collect(1);
...
//0A8E=3,%3d% = %1d% + %2d% ; int
eOpcodeResult CustomOpcodes::OPCODE_0A8E(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar + game.Scripts.Params[1].nVar;
    script->Store(1);
...
//0A8F=3,%3d% = %1d% - %2d% ; int
eOpcodeResult CustomOpcodes::OPCODE_0A8F(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar - game.Scripts.Params[1].nVar;
    script->Store(1);
...
//0A90=3,%3d% = %1d% * %2d% ; int
eOpcodeResult CustomOpcodes::OPCODE_0A90(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar * game.Scripts.Params[1].nVar;
    script->Store(1);
...
//0A91=3,%3d% = %1d% / %2d% ; int
eOpcodeResult CustomOpcodes::OPCODE_0A91(CCustomScript *script)
{
    script->Collect(2);
    game.Scripts.Params[0].nVar = game.Scripts.Params[0].nVar / game.Scripts.Params[1].nVar;
    script->Store(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0A99(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::OPCODE_0A9A(CCustomScript *script)
{
    script->Collect(1);
...
//0A9B=1,closefile %1d%
eOpcodeResult CustomOpcodes::OPCODE_0A9B(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0A9C(CCustomScript *script)
{
    script->Collect(1);
    FILE *file;
...
eOpcodeResult CustomOpcodes::OPCODE_0A9D(CCustomScript *script)
{
    script->Collect(3);
    FILE *file;
    file = (FILE *)game.Scripts.Params[0].pVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0A9E(CCustomScript *script)
{
    script->Collect(3);
    FILE *file;
    file = (FILE *)game.Scripts.Params[0].pVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0AA0(CCustomScript *script)
{
    script->Collect(1);
    script->m_aGosubAddr[script->m_nCurrentGosub++] = script->m_dwIp;
    if (!script->m_bCondResult)
...
eOpcodeResult CustomOpcodes::OPCODE_0AA1(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::OPCODE_0AA2(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0AA3(CCustomScript *script)
{
    script->Collect(1);
    HMODULE libHandle;
...
eOpcodeResult CustomOpcodes::OPCODE_0AA4(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::OPCODE_0AA9(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::OPCODE_0AAB(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0AC8(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0AC9(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0ACA(CCustomScript *script)
{
...
eOpcodeResult CustomOpcodes::OPCODE_0ACB(CCustomScript *script)
{
    static wchar_t message_buf[MAX_PATH];
    script->Collect(3);
...
eOpcodeResult CustomOpcodes::OPCODE_0ACC(CCustomScript *script)
{
    static wchar_t message_buf[MAX_PATH];
    script->Collect(2);
    const char *text = game.Scripts.Params[0].cVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0ACD(CCustomScript *script)
{
    static wchar_t message_buf[MAX_PATH];
    script->Collect(2);
    const char *text = game.Scripts.Params[0].cVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0ACE(CCustomScript *script)
{
    static wchar_t message_buf[MAX_PATH];
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0ACF(CCustomScript *script)
{
    script->Collect(3);
...
eOpcodeResult CustomOpcodes::OPCODE_0AD0(CCustomScript *script)
{
    script->Collect(2);
    char fmt[MAX_PATH]; char text[MAX_PATH]; static wchar_t message_buf[MAX_PATH];
    unsigned time;
...
eOpcodeResult CustomOpcodes::OPCODE_0AD1(CCustomScript *script)
{
    script->Collect(2);
    char fmt[MAX_PATH]; char text[MAX_PATH]; static wchar_t message_buf[MAX_PATH];
    unsigned time;
...
eOpcodeResult CustomOpcodes::OPCODE_0AD3(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::OPCODE_0AD4(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::OPCODE_0AD5(CCustomScript *script)
{
    script->Collect(3);
...
eOpcodeResult CustomOpcodes::OPCODE_0AD6(CCustomScript *script)
{
    script->Collect(1);
    FILE* file = (FILE*)game.Scripts.Params[0].pVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0AD7(CCustomScript *script)
{
    script->Collect(3);
    FILE* file = (FILE*)game.Scripts.Params[0].pVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0AD8(CCustomScript *script)
{
    script->Collect(2);
    FILE* file = (FILE*)game.Scripts.Params[0].pVar;
    char* buf = (char*)game.Scripts.Params[1].pVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0AD9(CCustomScript *script)
{
    script->Collect(2);
    char fmt[MAX_PATH]; char text[MAX_PATH];
    FILE* file = (FILE*)game.Scripts.Params[0].pVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0ADA(CCustomScript *script)
{
    script->Collect(2);
    char fmt[MAX_PATH];
    FILE* file = (FILE*)game.Scripts.Params[0].pVar;
...
eOpcodeResult CustomOpcodes::OPCODE_0ADB(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::OPCODE_0ADC(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0ADD(CCustomScript *script)
{
    script->Collect(1);
...
eOpcodeResult CustomOpcodes::OPCODE_0ADE(CCustomScript *script)
{
    script->Collect(2);
...
eOpcodeResult CustomOpcodes::OPCODE_0AE0(CCustomScript *script)
{
    script->Collect(1);
