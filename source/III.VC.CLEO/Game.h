...
#endif
        CCustomScript **pActiveScriptsList;
        void(__thiscall *AddScriptToList)(CCustomScript *, CCustomScript **);
        void(__thiscall *RemoveScriptFromList)(CCustomScript *, CCustomScript **);
        void(__thiscall *StoreParameters)(CCustomScript *, unsigned int *, unsigned int);
        void(__thiscall *UpdateCompareFlag)(CCustomScript *, bool);
